...
//			Dir = fd.getDirectory();
			System.out.println("调用GoFrame的save方法");
				...
				if (Global.getParameter("xml", false))
				{
					if (Global.isApplet())
					{
						fo = new PrintWriter(new OutputStreamWriter(
								...
								new FileOutputStream(directory + file),
								"UTF8"));
						B.saveXML(fo, "utf-8");
					}
					else
					{
						...
						else
						{
							...
							FileOutputStream fos = //new FileOutputStream(fd.getDirectory() + fn),
									new FileOutputStream(directory + file);
							try
							{
								fo = new PrintWriter(new OutputStreamWriter(
				...
				else
				{
					if (Global.isApplet())
						fo = new PrintWriter(new OutputStreamWriter(
							...
							//new FileOutputStream(fd.getDirectory() + fn),
							new FileOutputStream(directory + file), Global
