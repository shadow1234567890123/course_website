...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="${pageContext.request.contextPath}/user/changePassword" class="btn btn-default btn-flat">修改密码</a>
									</div>
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li id="auto-scoring">
								<a href="#">
									<i class="fa fa-circle-o"></i> 自动评分
								</a>
							</li>
							<li id="manual-input">
								<a href="#">
									<i class="fa fa-circle-o"></i> 手动录入
								</a>
							</li>
						</ul>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<li id="verify-material">
								<a href="#">
									<i class="fa fa-circle-o"></i> 审核资料
								</a>
							</li>
						</ul>
		...
		<div class="content-wrapper">
			<iframe id="student" width="100%" height="799px" src="${pageContext.request.contextPath}/pages/homepage.jsp">
